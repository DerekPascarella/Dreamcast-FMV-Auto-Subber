...
When using ASS format, users must set horizontal scaling (and any other font style and text placement settings) manually using their tool of choice (e.g., Aegisub). This includes `font_face`, `font_size`, `outline_color`, `margin_vertical`, etc. Instead, they are to be defined in the ASS subtitle file itself.
